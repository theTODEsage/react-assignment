...
// const Ticket = ({ ticket, setSelected}) => {
...
//         <div>
//             <div className="">
//                 <div onClick={()=>handleCard(ticket)} className="border-2 bg-white border-gray-300 rounded-lg p-6 flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow duration-200">
